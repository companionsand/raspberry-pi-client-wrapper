...
## 🎉 New: Simplified Device Authentication
...
- 🔐 **New: Device authentication with automatic key fetching**
...
### Option A: New Device (Recommended - Admin Portal Provisioning)
...
**If you provisioned via admin portal:** ✅ **No configuration needed!** Skip to step 5 to view logs.
